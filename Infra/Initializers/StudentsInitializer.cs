...
namespace App.Infra.Initializers {
    public sealed class StudentsInitializer : BaseInitializer<StudentData> {
        ...
        protected override IEnumerable<StudentData> getEntities => new StudentData[] {
            createStudent("Malle", "Kask", "53456789", "mallekalle@mail.com", "65", "175", "39", new DateTime(1985,05,05),"B1" ),
            createStudent("Kalle", "Tamm", "54456789", "kalletamm@mail.com", "75", "176", "42", new DateTime(1986,06,06),"B1"),
            createStudent("Tauno", "Vaher", "55456789", "taunovaher@mail.com", "76", "177", "43", new DateTime(1987,07,07),"B1"),
